...
#ifndef CLUMPSEDFAMILY_HPP
#define CLUMPSEDFAMILY_HPP
...
class clumpSEDFamily : public SEDFamily
{
    ITEM_CONCRETE(clumpSEDFamily, SEDFamily, "a user-provided, SED family for clumps")
